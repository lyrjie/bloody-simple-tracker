object Dependencies {
    ...
    const val kotlinSerializationRetrofitConverter =
        "com.jakewharton.retrofit:retrofit2-kotlinx-serialization-converter:${Versions.kotlinSerializationRetrofitConverter}"
    ...
    const val accompanistFlowLayouts =
    ...
    const val roomKotlinExt = "androidx.room:room-ktx:${Versions.room}"

    const val forasoftAndroid = "com.github.forasoft.android-utils:platform-android:${Versions.forasoftUtils}"
    const val forasoftCommon = "com.github.forasoft.android-utils:kotlin-common:${Versions.forasoftUtils}"
    const val forasoftCoroutines = "com.github.forasoft.android-utils:kotlin-coroutines:${Versions.forasoftUtils}"
    const val forasoftOkHttp = "com.github.forasoft.android-utils:thirdparty-okhttp:${Versions.forasoftUtils}"
    const val forasoftCompose = "com.github.forasoft.android-utils:ui-compose:${Versions.forasoftUtils}"
    const val forasoftClean = "com.github.forasoft.android-utils:clean:${Versions.forasoftUtils}"
    const val logpecker = "com.github.forasoft.android-utils:logpecker:${Versions.forasoftUtils}"
}
